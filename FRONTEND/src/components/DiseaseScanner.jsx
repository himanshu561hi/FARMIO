...
//     try {
//       const res = await fetch('http://localhost:5001/api/disease/guest-scan', {
//         method: 'POST',
//         body: formData,
//       });
...
//     try {
//       const res = await fetch('http://localhost:5001/api/disease/save', {
//         method: 'POST',
//         headers: {
...
//                         <h3 className="font-bold text-gray-700">🔍 Lakshan (Symptoms)</h3>
//                         <p className="text-sm text-gray-600">{result.symptoms}</p>
//                     </div>

//                     <div className="bg-green-50 p-3 rounded border border-green-200">
//                         <h3 className="font-bold text-green-700">🌿 Jaivik Upay (Organic)</h3>
//                         <p className="text-sm text-gray-700">{result.solution}</p>
//                     </div>

//                     <div className="bg-blue-50 p-3 rounded border border-blue-200">
//                         <h3 className="font-bold text-blue-700">🧪 Dawai (Medicine)</h3>
//                         <p className="text-sm text-gray-700">{result.medicine}</p>
//                     </div>
//                   </div>
