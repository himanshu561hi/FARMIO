...
//             Home
//           </Link>
//           <Link to="/scan-disease" className="text-xl font-semibold hover:text-amber-400 transition">
//             Fasal Jaanch
//           </Link>
//           <Link to="/lands" className="text-xl font-semibold hover:text-amber-400 transition">
//             Lands
//           </Link>
