...
//                   <Link to={text === "Home" ? "/" : `/${text.toLowerCase()}`} className="hover:text-cyan-400 transition-all duration-300 flex items-center gap-2">
...
//         {/* ========== NEW BLACK LEGAL STRIP (PATTI) ========== */}
//         <div className="w-full bg-[#050505] border-t border-white/5 py-3 relative z-20">
//             <div className="max-w-7xl mx-auto px-6 flex justify-center md:justify-end gap-8 text-[11px] tracking-widest uppercase font-medium text-gray-600">
...
//                           {/* Role Badge */}
//                           <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-gray-900 border border-white/10 px-3 py-1 rounded-full shadow-xl whitespace-nowrap z-10">
...
//                              className="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 hover:bg-[#0077b5] text-gray-400 hover:text-white transition-all duration-300 hover:scale-110">
//                             <FaLinkedin />
//                           </a>
//                           <a href={member.github} target="_blank" rel="noopener noreferrer"
//                              className="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 hover:bg-gray-700 text-gray-400 hover:text-white transition-all duration-300 hover:scale-110">
//                             <FaGithub />
//                           </a>
//                         </div>
