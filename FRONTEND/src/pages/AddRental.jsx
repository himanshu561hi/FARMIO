...
// import { createRental } from '../utils/api'; // Ensure this path matches your file structure
...
//   const [loading, setLoading] = useState(false); // To show "Submitting..." text

//   // 2. AUTH SAFETY CHECK (Prevents "Logout" issue)
//   useEffect(() => {
...
//     // Save the actual file object, not just the value
...
//     // Basic Validation
//     if (!image) {
//       alert("Please upload an image of the equipment.");
//       setLoading(false);
//       return;
//     }
...
//     data.append('image', image); // Must match backend: upload.single('image')
...
//       navigate('/rental'); // Redirect to marketplace after success
//     } catch (error) {
...
//             <textarea 
//               name="description" 
//               placeholder="Any details about condition, HP, etc." 
//               value={formData.description}
//               onChange={handleChange} 
//               className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-green-500 outline-none h-24" 
//             />
//           </div>
...
//             <div className="border border-dashed border-gray-400 p-4 rounded bg-gray-50 text-center">
//               <input 
//                 type="file" 
//                 accept="image/*"
...
const AddRental = () => {
  ...
  // 2. AUTH SAFETY CHECK (Alert replaced with Toast)
  useEffect(() => {
    const token = localStorage.getItem('token');
    if (!token) {
